                    ...
                    <div class="flex flex-row gap-2 border-b">
                        <div class="flex flex-col gap-4 border-r p-5">
                            <div class="flex flex-col gap-1">
                                ...
                                <div class="w-full relative">
                                    <input wire:model.blur='newStoreCode'
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <div class="relative w-full">
                                    <input wire:model.blur='newNameStoreCode'
                                        class="w-full outline-none text-black px-3 py-1 rounded-md" type="text"
                        ...
                        <div class="p-5 flex flex-col gap-1">
                            <div class="flex flex-col gap-1">
                                ...
                                <input wire:model='newIpGateway' class="outline-none text-black px-3 py-1 rounded-md"
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <input wire:model='newIpInduk' class="outline-none text-black px-3 py-1 rounded-md"
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <input wire:model='newIpAnak' class="outline-none text-black px-3 py-1 rounded-md"
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <input wire:model='newIpStb' class="outline-none text-black px-3 py-1 rounded-md"
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <input wire:model='newIpWdcp' class="outline-none text-black px-3 py-1 rounded-md"
