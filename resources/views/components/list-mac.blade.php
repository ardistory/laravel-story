<div>
    <div class="flex items-center justify-between border-b-[1px]">
        <div class="font-semibold text-md px-4 py-4 flex items-center gap-2">
            <div>
        ...
        <div class="flex mr-4">
            ...
            <input class="max-w-24 outline-none py-1 px-2 rounded-r-full text-black hover:ring hover:ring-teal-500"
