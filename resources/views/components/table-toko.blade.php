<div class="sm:px-6 w-full">
    ...
    <div class="bg-black py-4 md:py-7 px-4 md:px-8 xl:px-10">
        <div class="sm:flex items-center justify-between">
            <div class="flex items-center">
                <button class="rounded-full">
                    <div class="py-2 px-8 bg-white text-black rounded-full">
                        <p>All</p>
                    </div>
                </button>
                <button class="rounded-ful sm:ml-4 ml-8">
                    <div
                        class="py-2 px-8 bg-black text-white hover:bg-white hover:text-black rounded-full transition duration-250">
                        <p>Newest this month</p>
                    </div>
                </button>
            </div>
            <div class="flex items-center">
                <div class="bg-white text-black py-2 px-4 rounded-l-full">
                ...
                <input class="outline-none py-2 px-4 rounded-r-full text-black" type="text" name="search"
                    placeholder="tkbv / dc lebak">
            </div>
        </div>
